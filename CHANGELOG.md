...
## What's Changed
### Other Changes
* docs: Update API examples to v4 and add Android 16KB support documentation by @ahmtydn in https://github.com/ahmtydn/isar/pull/56
* Update documentation image format from SVG to PNG for better compatibility by @ahmtydn in https://github.com/ahmtydn/isar/pull/57


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.1.5...1.1.6
...
**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.1.4...1.1.5
...
**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.1.3...1.1.4
...
## What's Changed
### Other Changes
* Update README and documentation to use v4 API  by @ahmtydn in https://github.com/ahmtydn/isar/pull/49


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.1.2...1.1.3
...
## What's Changed
### Other Changes
* chore: update dependencies for compatibility with latest packages by @ahmtydn in https://github.com/ahmtydn/isar/pull/47


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.1.1...1.1.2
...
## What's Changed
### Other Changes
* feat: Implement OPFS support for Isar Plus on web by @ahmtydn in https://github.com/ahmtydn/isar/pull/39
* feat(web): implement persistent storage for web using sqlite-wasm-rs by @ahmtydn in https://github.com/ahmtydn/isar/pull/40
* refactor: remove obsolete Emscripten setup and precompile workflows by @ahmtydn in https://github.com/ahmtydn/isar/pull/43


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.28...1.1.1
...
## What's Changed
### Other Changes
* feat: Add deleteDatabase API for encrypted database cleanup by @ahmtydn in https://github.com/ahmtydn/isar/pull/38


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.27...1.0.28
...
## What's Changed
### Other Changes
* fix: update iOS deployment target to 13.0 and add Pods framework references by @ahmtydn in https://github.com/ahmtydn/isar/pull/36


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.26...1.0.27
...
## What's Changed
### Other Changes
* Fix plugin class naming to match Flutter's code generation expectations  by @ahmtydn in https://github.com/ahmtydn/isar/pull/34
* Fix plugin class naming to match Flutter's code generation expectations by @ahmtydn in https://github.com/ahmtydn/isar/pull/35


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.25...1.0.26
...
## What's Changed
### Other Changes
* Fix plugin class naming to match Flutter's code generation expectations by @ahmtydn in https://github.com/ahmtydn/isar/pull/33


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.24...1.0.25
...
## What's Changed
### Other Changes
* Fix generator for embedded schemas and bump isar to 1.0.24 by @ahmtydn in https://github.com/ahmtydn/isar/pull/31


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.23...1.0.24
...
## What's Changed
### Other Changes
* npm wasm publish by @ahmtydn in https://github.com/ahmtydn/isar/pull/29


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.22...1.0.23
...
## What's Changed
### Other Changes
* refactor: Updated the inspector URL by @ahmtydn in https://github.com/ahmtydn/isar/pull/28


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.21...1.0.22
...
## What's Changed
### Other Changes
* feat: enhance JSON serialization in ChangeDetector to handle nested values and Frame structures by @ahmtydn in https://github.com/ahmtydn/isar/pull/26


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.20...1.0.21
...
## What's Changed
### Other Changes
* refactor: Make fullDocument non-nullable with direct serialization by @ahmtydn in https://github.com/ahmtydn/isar/pull/25


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.19...1.0.20
...
## What's Changed
### Other Changes
* feat: add key field to watcher system for data identification by @ahmtydn in https://github.com/ahmtydn/isar/pull/24


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.18...1.0.19
...
## What's Changed
### Other Changes
* feat: refactor ChangeDetector to streamline change detection for objects and JSON by @ahmtydn in https://github.com/ahmtydn/isar/pull/23


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.17...1.0.18
...
## What's Changed
### Other Changes
* feat: update action versions and enhance change detection for JSON parsing by @ahmtydn in https://github.com/ahmtydn/isar/pull/22


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.16...1.0.17
...
## What's Changed
### Other Changes
* feat: improve error handling in ChangeDetail JSON deserialization and enhance Windows build script output by @ahmtydn in https://github.com/ahmtydn/isar/pull/20
* feat: remove unnecessary defines for MDBX_LOCK_SUFFIX and UNICODE in build script by @ahmtydn in https://github.com/ahmtydn/isar/pull/21


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.15...1.0.16
...
## What's Changed
### Other Changes
* feat: enhance FieldChange and ChangeDetail classes with document parseing support by @ahmtydn in https://github.com/ahmtydn/isar/pull/19


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.14...1.0.15
...
## What's Changed
### Other Changes
* feat: enhance watcher API with flexible document parsing by @ahmtydn in https://github.com/ahmtydn/isar/pull/18


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.13...1.0.14
...
## What's Changed
### Other Changes
* feat: Enhance detailed change tracking with field-level granularity and JSON serialization support by @ahmtydn in https://github.com/ahmtydn/isar/pull/17


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.12...1.0.13
...
## What's Changed
### Other Changes
* fix: resolve duplicate watcher events in detailed watchers (v1.0.4) by @ahmtydn in https://github.com/ahmtydn/isar/pull/16


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.11...1.0.12
...
## What's Changed
### Other Changes
* feat: Complete SQLite detailed change detection and fix all warnings by @ahmtydn in https://github.com/ahmtydn/isar/pull/15


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.10...1.0.11
...
## What's Changed
### Other Changes
* fix: update LIBMDBX_TAG to v0.13.8 for compatibility by @ahmtydn in https://github.com/ahmtydn/isar/pull/9
* refactor: remove unused feature flags and simplify function signatures by @ahmtydn in https://github.com/ahmtydn/isar/pull/11
* feat: Update libmdbx from v0.12.7 to v0.13.8  by @ahmtydn in https://github.com/ahmtydn/isar/pull/12
* refactor: update build process to manually create amalgamated source … by @ahmtydn in https://github.com/ahmtydn/isar/pull/13


**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.8...1.0.9
...
**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.1...1.0.2
...
**Full Changelog**: https://github.com/ahmtydn/isar/compare/1.0.0...1.0.1
...
⚠️ **DEPRECATED** - This version is deprecated. Please use isar 1.0.0+ instead.
